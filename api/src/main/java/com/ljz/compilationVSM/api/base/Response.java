...
public class Response<T> {
    ...
    //失败响应
    //增删改成功响应
    public static <Void>Response<Void> success(){return new Response(1,"success",null);}
    public static <T>Response<T> success(T data){return new Response(1,"success",data);}
    public static <Void>Response<Void> error(String message){return new Response(0,message,null);}
